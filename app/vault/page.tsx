    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          ...
          className={cn(
            ...
            hasReadyFiles
              ? "bg-gradient-to-r from-[#1e40af] to-[#3b82f6] text-white shadow-md shadow-[#1e40af]/20"
        ...
        <button
          onClick={onUploadClick}
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-gray-200 bg-white text-[#1e40af] shadow-sm transition-all hover:bg-gray-50 active:scale-95"
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-gray-400">
          {files.filter(f => f.status === "ready").length}/{files.length} 已就绪
        </span>
      </div>
