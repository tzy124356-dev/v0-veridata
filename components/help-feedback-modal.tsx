...
import { X, Send, Check, Lightbulb, AlertCircle, FileQuestion, Smile, HelpCircle } from "lucide-react"
import { cn } from "@/lib/utils"

// 反馈类型
const feedbackTypes = [
  { id: "suggestion", label: "功能建议", icon: Lightbulb },
  { id: "issue", label: "问题反馈", icon: AlertCircle },
  { id: "content-error", label: "内容错误", icon: FileQuestion },
